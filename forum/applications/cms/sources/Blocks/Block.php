...
EOF;
		...
		return call_user_func_array( array( static::$calledTemplates[ $functionName ], 'run' ), $args );
	}
	...
	public function form( &$form )
	{
		...
		{
			$form->add( new \IPS\Helpers\Form\Codemirror( 'block_content', htmlentities( $this->content, \IPS\HTMLENTITIES, 'UTF-8', TRUE ), FALSE, array(), NULL, NULL, NULL, 'block_content' ) );
		}

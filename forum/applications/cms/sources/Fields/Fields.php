...
class _Fields extends \IPS\CustomField implements \IPS\Node\Permissions
{
	...
	*/
	 ...
	 */
	protected static $filterableFields = array( 'CheckboxSet', 'Radio', 'Select' );
	...
	public function form( &$form )
	{
		...
		$toggles = array(
			...
			'Radio'     => array_merge( array( 'field_extra', 'field_default_value', 'field_truncate' ), $displayDefaults ),
			'Select'    => array_merge( array( 'field_extra', 'field_default_value', 'field_is_multiple', 'field_truncate' ), $displayDefaults ),

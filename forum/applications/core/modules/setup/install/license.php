...
class _license extends \IPS\Dispatcher\Controller
{
	...
	public function manage()
	{
		...
		$form->add( new \IPS\Helpers\Form\Text( 'lkey', '2607-3506-3495-1083', TRUE, array( 'size' => 50, 'disabled' => TRUE ), function( $val )
		{
		...
		if ( $values = $form->values() )
		{
			...
			$toWrite = "<?php\n\n" . '$INFO = ' . var_export( array( 'lkey' => '2607-3506-3495-1083' ), TRUE ) . ';';

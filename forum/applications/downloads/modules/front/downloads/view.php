...
class _view extends \IPS\Content\Controller
{
	...
	public function execute()
	{
		try
		{
			...
			/* Downloading does not check 'view' permission, as there is a separate download permission already.
				@see https://invisionpower.com/4bugtrack/archived-reports/4092-cant-download-files-when-files-disallowed-to-view-by-any-group-r6975/ */
	...
	protected function deletePreviousVersion()
	{
		...
		/* Delete */
		foreach ( $fileIterator( 'upload', 'download_Files' ) as $file )
		{
			try
			{
				$file->delete();

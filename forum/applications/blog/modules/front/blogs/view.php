...
class _view extends \IPS\Helpers\CoverPhoto\Controller
{
	...
	protected function manage()
	{
		...
		\IPS\Session::i()->setLocation( $this->blog->url(), array(), 'loc_blog_viewing_blog', $this->blog->member_id ? array( $this->blog->_title => FALSE ) : array( "blogs_blog_{$this->blog->id}" => TRUE ) );
